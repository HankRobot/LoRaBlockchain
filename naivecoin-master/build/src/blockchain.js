...
const hasher_js_1 = require("../lib/hasher.js");
const private_key_js_1 = require("../lib/private-key.js");
const prng_js_1 = require("../lib/prng.js");
const ringgen = () => {
    const prng = new prng_js_1.default();
    const hasher = new hasher_js_1.default();
    const key = new private_key_js_1.default(prng.random, hasher);
    //create private keys and their corresponding public keys
    const foreign_keys = [new private_key_js_1.default(prng.random, hasher).public_key,
        new private_key_js_1.default(prng.random, hasher).public_key,
        new private_key_js_1.default(prng.random, hasher).public_key];
    //message to sign
