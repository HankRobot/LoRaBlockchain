...
const private_key_1 = require("./lib/private-key");
const prng_1 = require("./lib/prng");
const ringgen = () => {
    const prng = new prng_1.default();
    const hasher = new hasher_1.default();
    const key = new private_key_1.default(prng.random, hasher);
    //create private keys and their corresponding public keys
    const foreign_keys = [new private_key_1.default(prng.random, hasher).public_key,
        new private_key_1.default(prng.random, hasher).public_key,
        new private_key_1.default(prng.random, hasher).public_key];
    //message to sign
